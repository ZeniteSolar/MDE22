...
inline void average_measurements(void) {
  measurements.batvoltage_avg =
      measurements.batvoltage_avg_sum / measurements.batvoltage_avg_sum_count;
  measurements.position_avg =
      measurements.position_avg_sum / measurements.position_avg_sum_count;
  measurements.batcurrent_avg =
      measurements.batcurrent_avg_sum / measurements.batcurrent_avg_sum_count;
}
